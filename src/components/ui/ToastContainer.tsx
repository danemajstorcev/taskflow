...
function Toast({
  ...
  return (
    <div
      className="flex items-start gap-2.5 px-4 py-3 shadow-lg text-sm font-medium border toast-enter max-w-xs"
      style={{
        background: BG[variant],
        borderColor: FG[variant] + "40",
        color: FG[variant],
      }}
    >
      ...
      <span className="flex-1 text-base" style={{ color: "var(--text)" }}>
        {message}
      </span>
      <button
