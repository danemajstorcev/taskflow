  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 flex-wrap mb-2">
        ...
        {overdue && (
          <span
            className="text-[10px] font-bold font-mono uppercase px-1.5 py-0.5"
      ...
      <div className="flex items-center justify-between">
        {assignee ? (
          <div className="flex items-center gap-1.5">
            <div
              className="w-5 h-5 flex items-center justify-center text-[9px] font-bold text-white flex-shrink-0"
        ...
        <div className="flex items-center gap-2">
          ...
          {task.dueDate && (
            <span
              className="text-[11px] font-mono"
              style={{ color: overdue ? "var(--danger)" : "var(--text3)" }}
            >
...
export default function KanbanBoard() {
  ...
  const onDragOver = (e: React.DragEvent, s: Status) => {
    e.preventDefault();
    setOverCol(s);
  };
  ...
  const onDrop = (e: React.DragEvent, s: Status) => {
    ...
    if (id) {
      dispatch(moveTask({ id, status: s }));
      dispatch(addToast({ message: `Moved to ${s}`, variant: "info" }));
    }
    setOverCol(null);
  };
